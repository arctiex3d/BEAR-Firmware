...
#define TMC2130_CURRENTS_H {18, 22, 40, 30}  // default holding currents for all axes
#define TMC2130_CURRENTS_R {18, 22, 40, 30}  // default running currents for all axes
